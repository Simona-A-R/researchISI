 ...
 * This is done by combining Word2VecEx vectors and a recurrent neural network model. Each word in a review is vectorized
 * (using the Word2VecEx model) and fed into a recurrent neural network.
 ...
 * 2. Load existing Word2VecEx model (for example: Google News word vectors. You will have to download this MANUALLY)
...
public class Word2VecSentimentRNN {
    ...
    public static final String WORD_VECTORS_PATH = "GoogleNews-vectors-negative300.bin.gz";
